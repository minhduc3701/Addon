...
var Sticky = /** @class */ (function (_super) {
  ...
  function Sticky(props) {
    ...
    _this._onScrollEvent = function (container, footerStickyContainer) {
      if (_this.root && _this.nonStickyContent) {
        ...
        if (_this.canStickyTop) {
          var distanceToStickTop =
            distanceFromTop - _this._getStickyDistanceFromTop();
        ...
        if (
          _this.canStickyBottom &&
          container.clientHeight - footerStickyContainer.offsetHeight <=
            distanceFromTop
        ) {
          isStickyBottom =
            distanceFromTop - Math.floor(container.scrollTop) >=
            _this._getStickyDistanceFromTopForFooter(
              container,
    ...
    _this._getStickyDistanceFromTopForFooter = function (
      container,
      ...
      if (_this.stickyContentBottom) {
        distance =
          ...
          footerStickyVisibleContainer.offsetHeight +
          _this.stickyContentBottom.offsetTop;
      }
      return distance;
    };
  ...
  Object.defineProperty(Sticky.prototype, "canStickyTop", {
    get: function () {
      return (
        this.props.stickyPosition === StickyPositionType.Both ||
        this.props.stickyPosition === StickyPositionType.Header
      );
    },
    enumerable: true,
    configurable: true,
  ...
  Object.defineProperty(Sticky.prototype, "canStickyBottom", {
    get: function () {
      return (
        this.props.stickyPosition === StickyPositionType.Both ||
        this.props.stickyPosition === StickyPositionType.Footer
      );
    },
    enumerable: true,
    configurable: true,
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        (isStickyTop || isStickyBottom) &&
          React.createElement("span", { style: hiddenContentStyle }, children),
        React.createElement(
          "div",
          {
            ...
            className:
              isStickyTop || isStickyBottom ? stickyClassName : undefined,
  ...
  Sticky.prototype._getContentStyles = function (isSticky) {
    return {
      backgroundColor:
        this.props.stickyBackgroundColor || this._getBackground(),
