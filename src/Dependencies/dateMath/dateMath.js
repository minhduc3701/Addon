...
export function getWeekNumbersInMonth(
  ...
  for (var i = 0; i < weeksInMonth; i++) {
    ...
    weeksArray.push(
      getWeekNumber(endOfWeekRange, firstDayOfWeek, firstWeekOfYear)
    );
...
function getWeekOfYearFullDays(date, firstDayOfWeek, numberOfFullDays) {
  ...
  var lastDayOfPrevYear = new Date(
    date.getFullYear() - 1,
  ...
  var num2 =
    (firstDayOfWeek - num + 2 * TimeConstants.DaysInOneWeek) %
    TimeConstants.DaysInOneWeek;
...
function getFirstDayWeekOfYear(date, firstDayOfWeek) {
  ...
  var num3 =
    (num2 - firstDayOfWeek + 2 * TimeConstants.DaysInOneWeek) %
    TimeConstants.DaysInOneWeek;
