 ...
 */
export declare type __MapToFunctionType<T> = Extract<T, Function> extends never
  ? (...args: any[]) => Partial<T>
  : Extract<T, Function>;
/**
 ...
 */
export declare type IConcatenatedStyleSet<
  TStyleSet extends IStyleSet<TStyleSet>
> = {
  [P in keyof Omit<TStyleSet, "subComponentStyles">]: IStyle;
} & {
 ...
 */
export declare type IProcessedStyleSet<
  TStyleSet extends IStyleSet<TStyleSet>
> = {
