...
export function classNamesFunction(options) {
  ...
  var getClassNames = function (styleFunctionOrObject, styleProps) {
        ...
        current[RetVal] = mergeCssSets(
          ...
          ],
          {
            ...
            specificityMultiplier: options.useStaticStyles
              ? DEFAULT_SPECIFICITY_MULTIPLIER
              : undefined,
          }
        );
      }
    ...
    if (styleCalcCount > (options.cacheSize || MAX_CACHE_COUNT)) {
      ...
      if (
        (_b =
          (_a = win) === null || _a === void 0 ? void 0 : _a.FabricConfig) ===
          null || _b === void 0
          ? void 0
          : _b.enableClassNameCacheFullWarning
      ) {
        console.warn(
