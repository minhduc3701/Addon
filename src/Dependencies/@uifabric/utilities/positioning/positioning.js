...
import { getScrollbarWidth, getRTL } from "../index";
import { Rectangle as FullRectangle } from "../Rectangle";
...
var DirectionalDictionary =
  ((_a = {}),
  (_a[DirectionalHint.topLeftEdge] = _createPositionData(
    RectangleEdge.top,
    RectangleEdge.left
  )),
  (_a[DirectionalHint.topCenter] = _createPositionData(RectangleEdge.top)),
  (_a[DirectionalHint.topRightEdge] = _createPositionData(
    RectangleEdge.top,
    RectangleEdge.right
  )),
  (_a[DirectionalHint.topAutoEdge] = _createPositionData(
    RectangleEdge.top,
    undefined,
    true
  )),
  (_a[DirectionalHint.bottomLeftEdge] = _createPositionData(
    RectangleEdge.bottom,
    RectangleEdge.left
  )),
  (_a[DirectionalHint.bottomCenter] = _createPositionData(
    RectangleEdge.bottom
  )),
  (_a[DirectionalHint.bottomRightEdge] = _createPositionData(
    RectangleEdge.bottom,
    RectangleEdge.right
  )),
  (_a[DirectionalHint.bottomAutoEdge] = _createPositionData(
    RectangleEdge.bottom,
    undefined,
    true
  )),
  (_a[DirectionalHint.leftTopEdge] = _createPositionData(
    RectangleEdge.left,
    RectangleEdge.top
  )),
  (_a[DirectionalHint.leftCenter] = _createPositionData(RectangleEdge.left)),
  (_a[DirectionalHint.leftBottomEdge] = _createPositionData(
    RectangleEdge.left,
    RectangleEdge.bottom
  )),
  (_a[DirectionalHint.rightTopEdge] = _createPositionData(
    RectangleEdge.right,
    RectangleEdge.top
  )),
  (_a[DirectionalHint.rightCenter] = _createPositionData(RectangleEdge.right)),
  (_a[DirectionalHint.rightBottomEdge] = _createPositionData(
    RectangleEdge.right,
    RectangleEdge.bottom
  )),
  _a);
...
function _moveEdge(rect, edge, newValue) {
  ...
  rect = _setEdgeValue(
    rect,
    edge * -1,
    _getEdgeValue(rect, edge * -1) - difference
  );
  return rect;
}
/**
...
function _flipAlignmentEdge(elementEstimate, target, gap, coverTarget) {
  ...
  var newEstimate = _estimatePosition(
    elementRectangle,
    target,
...
function _finalizeReturnEdge(elementRectangle, returnEdge, bounds) {
  if (
    ...
    Math.abs(_getRelativeEdgeDifference(elementRectangle, bounds, returnEdge)) >
      Math.abs(
        _getRelativeEdgeDifference(elementRectangle, bounds, returnEdge * -1)
      )
  ) {
    return returnEdge * -1;
  }
...
function _finalizeElementPosition(
  ...
  returnValue[RectangleEdge[returnEdge]] = _getRelativeEdgeDifference(
    elementRectangle,
    hostRect,
    returnEdge
  );
...
function _getPositionData(
  ...
  var positionInformation = __assign(
    {},
...
function _finalizeBeakPosition(elementPosition, positionedBeak, bounds) {
  ...
  var actualElement = new Rectangle(
    0,
  ...
  var returnValue = {};
  var returnEdge = _finalizeReturnEdge(
...
function _positionBeak(beakWidth, elementPosition) {
  ...
  beakPosition = _centerEdgeToPoint(
    ...
    elementPosition.targetEdge * -1,
    beakTargetPoint -
      _getRelativeRectEdgeValue(positiveEdge, elementPosition.elementRectangle)
  );
...
function _getTargetRect(bounds, target) {
  ...
  if (target) {
    ...
    if (!_isRectangleWithinBounds(targetRectangle, bounds)) {
      ...
      for (
        var _i = 0, outOfBounds_1 = outOfBounds;
...
function _getMaxHeightFromTargetRectangle(
  ...
  var target = coverTarget
    ? directionalHint.targetEdge * -1
...
function _positionElementRelative(
  ...
  var positionData = _getAlignmentData(
    _getPositionData(
  ...
  var positionedElement = _positionElementWithinBounds(
...
function _finalizePositionData(
  ...
  var finalizedElement = _finalizeElementPosition(
...
function _positionElement(
  ...
  var positionedElement = _positionElementRelative(
    props,
    elementToPosition,
    boundingRect,
    previousPositions
  );
  return _finalizePositionData(
    positionedElement,
    hostElement,
    boundingRect,
    props.coverTarget
...
function _positionCallout(
  ...
  var finalizedBeakPosition = _finalizeBeakPosition(
    positionedElement,
    beakPositioned,
    boundingRect
  );
