...
var CalloutContentBase = /** @class */ (function (_super) {
  ...
  // tslint:disable-next-line function-name
  CalloutContentBase.prototype.UNSAFE_componentWillUpdate = function (
    newProps
  ) {
  ...
  CalloutContentBase.prototype.render = function () {
    ...
    var overflowStyle = __assign(
      __assign(__assign({}, style), { maxHeight: contentMaxHeight }),
    ...
    var content = React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Popup,
          __assign({}, getNativeProps(this.props, ARIA_ROLE_ATTRIBUTES), {
            ariaLabel: ariaLabel,
  ...
  CalloutContentBase.prototype._dismissOnClickOrScroll = function (ev) {
    ...
    var isEventTargetOutsideCallout =
      ...
      !elementContains(this._hostElement.current, target);
  ...
  CalloutContentBase.prototype._addListeners = function () {
    ...
    this._async.setTimeout(function () {
      _this._disposables.push(
        on(_this._targetWindow, "scroll", _this._dismissOnScroll, true),
        on(_this._targetWindow, "resize", _this._dismissOnResize, true),
        on(
