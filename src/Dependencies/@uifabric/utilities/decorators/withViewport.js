  ...
  return /** @class */ (function (_super) {
    ...
    function WithViewportComponent(props) {
      ...
      _this._updateViewport = function (withForceUpdate) {
        ...
        if (
          isSizeChanged &&
          _this._resizeAttempts < MAX_RESIZE_ATTEMPTS &&
          clientRect &&
          scrollRect
        ) {
    ...
    WithViewportComponent.prototype.render = function () {
      ...
      return React.createElement(
        ...
        React.createElement(
          ComposedComponent,
          __assign(
            { ref: this._updateComposedComponentRef, viewport: newViewport },
            this.props
          )
        )
      );
