...
import { EventGroup, getDocument } from "../index";
...
var DragDropHelper = /** @class */ (function () {
  ...
  DragDropHelper.prototype.subscribe = function (
    root,
    events,
    dragDropOptions
  ) {
    ...
    if (dragDropOptions && root) {
      ...
      if (isDraggable || isDroppable) {
        if (eventMap) {
          for (
            var _i = 0, eventMap_1 = eventMap;
            _i < eventMap_1.length;
            _i++
          ) {
  ...
  DragDropHelper.prototype._onMouseUp = function (event) {
    ...
    if (this._dragData) {
      for (
        var _i = 0, _a = Object.keys(this._activeTargets);
        _i < _a.length;
        _i++
      ) {
        var key = _a[_i];
