...
function _registerFontFace(fontFamily, url, fontWeight, localFontName) {
  ...
  var localFontSrc =
    localFontName !== undefined ? "local('" + localFontName + "')," : "";
  fontFace({
    fontFamily: fontFamily,
    src:
      localFontSrc +
...
function _getFontBaseUrl() {
  ...
  var fabricConfig =
    (_a = getWindow()) === null || _a === void 0 ? void 0 : _a.FabricConfig;
  return (
    (_c =
      (_b = fabricConfig) === null || _b === void 0 ? void 0 : _b.fontBaseUrl),
    _c !== null && _c !== void 0 ? _c : DefaultBaseUrl
  );
}
/**
