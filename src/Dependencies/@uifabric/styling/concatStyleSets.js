...
export function concatStyleSets() {
  ...
  if (Object.keys(workingSubcomponentStyles).length > 0) {
    ...
    for (var subCompProps in workingSubcomponentStyles) {
      _loop_1(subCompProps);
    }
  }
  return mergedSet;
}
